...
export const RESPONSE_ORDER = [
  ...
  "Vai piorar",
  "Mais positivas",
  "Nem positivas, nem negativas (NÃO LER)",
  "Mais negativas",
  "Não leio/vejo/ouço notícias sobre o Governo Federal (NÃO LER)",
  "Aumentaram muito",
  "Aumentaram um pouco",
  "Continuaram iguais",
  "Diminuíram um pouco",
  ...
  "Discorda totalmente",
  "O Governo atual",
  "Os dois, de maneira igual (ESPONTÂNEO, NÃO LER)",
  "O Governo anterior",
  "Nenhum dos dois (ESPONTÂNEO, NÃO LER)",  
  "NS/NR",
  "Não sabe",
  "Não respondeu",
]
